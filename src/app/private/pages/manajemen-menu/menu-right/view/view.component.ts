...
export class ViewComponent implements OnInit {
	...
	ngOnInit(): void {
		...
		this.getState.subscribe((state) => {
			...
			//     status_aktif : String(this.menuRight.status_aktif)
			//   })
			// this.modalService.open(this.formContent, { ariaLabelledBy: "modal-basic-title" });
			// }
			if (this.reloadTable) {
				this.reLoadData()
				// this.modalService.dismissAll(this.formContent)
			}
		})
	}
	...
	SubmitForm() {
		...
		// console.log([this.menuRight, this.menuRight.id_menu_right])
		/**
		...
		payload.status_aktif = this.formTambah.value.status_aktif
	...
	editData(data: any) {
		...
		// this.titleModal= "Form Edit Menu Right"
		// this.store.dispatch(
		//   MenuRightActions.getMenuRightById({ payload : { id : data.id_menu_right } })
		// )
	}
	nonAktif(data: any) {
		Swal.fire({
