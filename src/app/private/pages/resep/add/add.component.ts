		...
		.subscribe(res => {
			if(res.metaData.response_code=='0000'){
				this.formDiagnosa.patchValue({
					// keluhan: res.response.keluhan,
					// biaya_dokter: res.response.biaya_dokter,
					// obyektif_dokter: res.response.obyektif_dokter,
					// planning: res.response.planning,
					// resep_obat: res.response.resep_obat == null ? 'R/' : res.response.resep_obat,
					tindakan: res.response.tindakan,
					alergi: res.response.alergi,
					// bb: res.response.bb,
					// catatan_khusus: res.response.catatan_khusus,
					// diastole: res.response.diastole,
					// hambatan: res.response.hambatan,
					// hr: res.response.hr,
					// keterangan_rr: res.response.keterangan_rr,
					// pxfisik: res.response.pxfisik,
					// rr: res.response.rr,
					// sistole: res.response.sistole,
					// status_hr: res.response.status_hr,
					// suhu: res.response.suhu,
					// tb: res.response.tb,
				})
