    ...
    return {
      ...
      columns: [
        ...
        {data:'nama_poliklinik'},
        {
          ...
          searchable: false,
          render(data: any, type: any, row: any, full: any) {
            // return del?`<div style="white-space: nowrap;">
            //           <button class="btn btn-sm btn-purple odontogram"><img src='assets/images/gigi.png' /></button>
            //           <button class="btn btn-sm btn-danger hapus-antrian">Hapus Antrean</button>
            //         <div>`:'';
            return del&&row.proses_antrian!='sudah'?`<div style="white-space: nowrap;">
                  ...
                  <button class="btn btn-sm btn-danger hapus-antrian" disabled>Hapus Antrean</button>
                <div>`:'';
          }
        }
      ],
