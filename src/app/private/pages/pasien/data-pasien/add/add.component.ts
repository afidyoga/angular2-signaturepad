...
export class AddComponent implements OnInit {
  ...
  prosesSelectProvinsi(event : any, aksi : string) {
    if (aksi == 'search')
		...
		if(aksi=="last_page"){
			let last=this.paramDesaKtp.last_data+this.paramDesaKtp.get_data
			this.paramDesaKtp.last_data=last
		}else{
			this.paramDesaKtp.last_data=0
		}
    if (aksi == 'last_page') {
      this.paramProvinsiKtp.get_data = this.paramProvinsiKtp.get_data + 10
    }
    this.wilayahService.getProvinsiSelectOption(this.paramProvinsiKtp)
    .subscribe(succ => {
      this.listProvinsiKtp = succ.response
    })
  }
  onFocus(id){
    document.getElementById(id).click()
  }
  // searchListProvinsiKtp(event : any) {
  //   this.paramProvinsiKtp.search = event.term
  //   this.wilayahService.getProvinsiSelectOption(this.paramProvinsiKtp)
  //   .subscribe(succ => { this.listProvinsiKtp = succ.response })
  // }
  // openListProvinsiKtp() {
  //   this.paramProvinsiKtp.get_data = 10
  ...
  searchListKabupatenKtp(event : any) {
    if(this.idProvinsiKtp != null) {
      ...
      .subscribe(succ => { this.listKabupatenKtp = succ.response })
    }
  }
  searchListKecamatanKtp(event : any) {
    if(this.idKabupatenKtp != null) {
      ...
      .subscribe(succ => { this.listKecamatanKtp = succ.response })
    }
  }
  searchListDesaKtp(event : any) {
    if(this.idKecamatanKtp != null) {
      this.paramDesaKtp.search = event.term
      this.wilayahService.getDesaSelectOption(this.paramDesaKtp, this.idKecamatanKtp)
      .subscribe(succ => { this.listDesaKtp = succ.response })
    }
  }

  openListKabupatenKtp() {
    if(this.idProvinsiKtp != null) {
      this.paramKabupatenKtp.get_data = 10
      this.paramKabupatenKtp.search = ""
      this.wilayahService.getKabupatenSelectOption(this.paramKabupatenKtp, this.idProvinsiKtp)
      .subscribe(succ => { this.listKabupatenKtp = succ.response })
    }
  }
  openListKecamatanKtp() {
    if(this.idKabupatenKtp != null) {
      this.paramKecamatanKtp.get_data = 10
  ...
  openListDesaKtp() {
    if(this.idKecamatanKtp != null) {
      let param = this.paramDesaKtp
      this.wilayahService.getDesaSelectOption(param, this.idKecamatanKtp)
      .subscribe(succ => { this.listDesaKtp = succ.response })
    }
  }

  scollEndKabupatenKtp() {
    if(this.idProvinsiKtp != null) {
      this.paramKabupatenKtp.get_data = this.paramKabupatenKtp.get_data + 10
      this.wilayahService.getKabupatenSelectOption(this.paramKabupatenKtp, this.idProvinsiKtp)
      .subscribe(succ => { this.listKabupatenKtp = succ.response })
    }
  }
  scollEndKecamatanKtp() {
    if(this.idKabupatenKtp != null) {
      this.paramKecamatanKtp.get_data = this.paramKecamatanKtp.get_data + 10
      this.wilayahService.getKecamatanSelectOption(this.paramKecamatanKtp, this.idKabupatenKtp)
      .subscribe(succ => { this.listKecamatanKtp = succ.response })
    }
  }
  scollEndDesaKtp() {
    if(this.idKecamatanKtp != null) {
      this.paramDesaKtp.get_data = this.paramDesaKtp.get_data + 10
      this.wilayahService.getDesaSelectOption(this.paramDesaKtp, this.idKecamatanKtp)
      .subscribe(succ => { this.listDesaKtp = succ.response })
    }
  }
  ...
  searchListProvinsiDomisili(event : any) {
    this.paramProvinsiDomisili.search = event.term
    this.wilayahService.getProvinsiSelectOption(this.paramProvinsiDomisili)
    .subscribe(succ => { this.listProvinsiDomisili = succ.response })
  }
  openListProvinsiDomisili() {
    let param = this.paramProvinsiDomisili
    this.wilayahService.getProvinsiSelectOption(param)
    .subscribe(succ => { this.listProvinsiDomisili = succ.response })
  }
  scollEndProvinsiDomisili(){
    this.paramProvinsiDomisili.get_data = this.paramProvinsiDomisili.get_data + 10
    this.wilayahService.getProvinsiSelectOption(this.paramProvinsiDomisili)
    .subscribe(succ => { this.listProvinsiDomisili = succ.response })
  }

  searchListKabupatenDomisili(event : any) {
    if(this.idProvinsiDomisili != null) {
      ...
      .subscribe(succ => { this.listKabupatenDomisili = succ.response })
    }
  }
  searchListKecamatanDomisili(event : any) {
    if(this.idKabupatenDomisili != null) {
      ...
      .subscribe(succ => { this.listKecamatanDomisili = succ.response })
    }
  }
  searchListDesaDomisili(event : any) {
    if(this.idKecamatanDomisili != null) {
      ...
      .subscribe(succ => { this.listDesaDomisili = succ.response })
    }
  }

  openListKabupatenDomisili() {
    if(this.idProvinsiDomisili != null) {
      this.paramKabupatenDomisili.get_data = 10
      this.paramKabupatenDomisili.search = ""
      this.wilayahService.getKabupatenSelectOption(this.paramKabupatenDomisili, this.idProvinsiDomisili)
      .subscribe(succ => { this.listKabupatenDomisili = succ.response })
    }
  }
  openListKecamatanDomisili() {
    if(this.idKabupatenDomisili != null) {
      this.paramKecamatanDomisili.get_data = 10
      this.paramKecamatanDomisili.search = ""
      this.wilayahService.getKecamatanSelectOption(this.paramKecamatanDomisili, this.idKabupatenDomisili)
      .subscribe(succ => { this.listKecamatanDomisili = succ.response })
    }
  }
  openListDesaDomisili() {
    if(this.idKecamatanDomisili != null) {
      this.paramDesaDomisili.get_data = 10
  ...
  scollEndKabupatenDomisili() {
    if(this.idProvinsiDomisili != null) {
      this.paramKabupatenDomisili.get_data = this.paramKabupatenDomisili.get_data + 10
      this.wilayahService.getKabupatenSelectOption(this.paramKabupatenDomisili, this.idProvinsiDomisili)
      .subscribe(succ => { this.listKabupatenDomisili = succ.response })
    }
  }
  scollEndKecamatanDomisili() {
    if(this.idKabupatenDomisili != null) {
      this.paramKecamatanDomisili.get_data = this.paramKecamatanDomisili.get_data + 10
      this.wilayahService.getKecamatanSelectOption(this.paramKecamatanDomisili, this.idKabupatenDomisili)
      .subscribe(succ => { this.listKecamatanDomisili = succ.response })
    }
  }
  scollEndDesaDomisili() {
    if(this.idKecamatanDomisili != null) {
      this.paramDesaDomisili.get_data = this.paramDesaDomisili.get_data + 10
      this.wilayahService.getDesaSelectOption(this.paramDesaDomisili, this.idKecamatanDomisili)
      .subscribe(succ => { this.listDesaDomisili = succ.response })
    }
  }
