...
// import * as StokAction from 'src/app/private/states/alat-kesehatan/alat-kesehatan.action'
...
export class DetailComponent implements OnInit {
	...
	ngOnInit(): void {
		this.activatedRoute.params.subscribe(async (params: Params) => {
			if (params) {
				...
				this.id_alat=params.id
				this.alat=decodeURIComponent(params.alat)
	...
	editKatalog(id: any) {
		this.router.navigate(['barang', 'katalog', 'edit-buat-baru', this.id_alat,'stok_detail'])
	}
	toInt(itm) {
		return parseInt(itm)
	}
