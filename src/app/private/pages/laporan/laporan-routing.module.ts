...
import { LabaMarginModule } from './laba-margin/laba-margin.module';
import { LabaMarginAlatModule } from './laba-margin-alat/laba-margin.module';
...
const routes: Routes = [
	...
	{
		path: 'laba-margin',
		loadChildren: () => import('./laba-margin/laba-margin.module').then((m) => LabaMarginModule)
	},
	{
	...
	{
		path: 'laba-margin-alat',
		loadChildren: () => import('./laba-margin-alat/laba-margin.module').then((m) => LabaMarginAlatModule)
	},
	{
		path: 'resep',
