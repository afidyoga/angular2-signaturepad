...
export class ViewComponent implements OnInit {
	...
	reLoadData() {
		...
		this.router.navigate(['laporan/penjualan-omset/view/'+moment(this.convertTime(this.formInput.value.date_month[0])).format("YYYY-MM-DD")+'/'+moment(this.convertTime(this.formInput.value.date_month[1])).format("YYYY-MM-DD")])
		// this.getGrafikData()
